...
public class AnimFactory extends BOAbstractFactory implements IBOAnim, ITechShiftLine {
   ...
   public ByteObject getAnimGradient(ByteObject pointer, ByteObject gradient, int timing, int target, int size) {
      ...
      p.setValue(ANIM_OFFSET_01_TYPE1, ITechAnim.ANIM_TYPE_08_GRADIENT, 1);
   ...
   public ByteObject getAnimationAlpha(int type, boolean up, int repeat) {
      ByteObject p = getBOFactory().createByteObject(IBOTypesGui.TYPE_130_ANIMATION, ANIM_BASIC_SIZE);
      p.setValue(ANIM_OFFSET_01_TYPE1, ITechAnim.ANIM_TYPE_06_ALPHA, 1);
   ...
   public IAnimable createDrawableAnimable(ByteObject anim, IDrawable d) {
      ...
      switch (animType) {
         ...
         case ITechAnim.ANIM_TYPE_08_GRADIENT:
         ...
         case ITechAnim.ANIM_TYPE_03_MOVE:
            ...
            boolean origin = anim.get1(ANIM_OFFSET_05_TIME1) == ITechAnim.ANIM_TIME_1_ENTRY;
   ...
   public ByteObject getAnimMove(int type, boolean origine, ByteObject anchor2) {
      ByteObject p = getBOFactory().createByteObject(IBOTypesGui.TYPE_130_ANIMATION, ANIM_BASIC_SIZE);
      p.setValue(ANIM_OFFSET_01_TYPE1, ITechAnim.ANIM_TYPE_03_MOVE, 1);
      return p;
   }
   ...
   public ByteObject getAnimReverse(int timing) {
      ByteObject p = getBOFactory().createByteObject(IBOTypesGui.TYPE_130_ANIMATION, ANIM_BASIC_SIZE);
      p.setValue(ANIM_OFFSET_01_TYPE1, ITechAnim.ANIM_TYPE_02_REVERSE, 1);
      p.setValue(ANIM_OFFSET_05_TIME1, timing, 1);
      return p;
   }
   ...
   public ByteObject getAnimationValue(ByteObject pointer, ByteObject function, int time, int target, int sleep, int repeat, ByteObject sleepFun) {
      ByteObject p = getBOFactory().createByteObject(IBOTypesGui.TYPE_130_ANIMATION, ANIM_BASIC_SIZE);
      p.setValue(ANIM_OFFSET_01_TYPE1, ITechAnim.ANIM_TYPE_01_VALUE, 1);
      p.setValue(ANIM_OFFSET_04_DRAW_TYPE1, ITechAnim.ANIM_DRAW_2_DRAWABLE, 1);
      p.setValue(ANIM_OFFSET_05_TIME1, time, 1);
      p.setValue(ANIM_OFFSET_06_TARGET1, target, 1);
      if (repeat == -1) {
         p.setFlag(ANIM_OFFSET_02_FLAG, ANIM_FLAG_3_LOOP, true);
         p.setValue(ANIM_OFFSET_07_REPEAT1, 0, 1);
      } else {
         p.setValue(ANIM_OFFSET_07_REPEAT1, repeat, 1);
      }
   ...
   public ByteObject getAnimPixel(int type, boolean isOut) {
      ByteObject p = getBOFactory().createByteObject(IBOTypesGui.TYPE_130_ANIMATION, ANIM_BASIC_SIZE);
      p.setValue(ANIM_OFFSET_01_TYPE1, ITechAnim.ANIM_TYPE_04_PIXELATE, 1);
      p.setValue(ANIM_OFFSET_05_TIME1, type, 1);
   ...
   public ByteObject getAnimShiftLines(int timing) {
      ByteObject p = getBOFactory().createByteObject(IBOTypesGui.TYPE_130_ANIMATION, ANIM_BASIC_SIZE);
      p.setValue(ANIM_OFFSET_01_TYPE1, ITechAnim.ANIM_TYPE_05_LINE_SHIFT, 1);
      p.setValue(ANIM_OFFSET_05_TIME1, timing, 1);
      return p;
   }
