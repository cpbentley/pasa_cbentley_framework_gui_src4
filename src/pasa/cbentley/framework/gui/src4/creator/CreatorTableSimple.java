...
public class CreatorTableSimple extends CreatorAbstractTable {

   public CreatorTableSimple(CreateContext gc) {
      super(gc);
   }
   ...
   public ByteObject getTableTech() {
      ...
      boolean showColTitles = true;
      boolean showRowTitles = true;
