...
public class ConfigGuiCtxDefault extends ConfigAppAbstract implements IConfigAppGui {
   ...
   public ConfigGuiCtxDefault(UCtx uc) {
      super(uc, "DefaultAppName");
   }

   public ConfigGuiCtxDefault(UCtx uc, String name) {
      super(uc, name);
   }
   ...
   public void toString(Dctx dc) {
      dc.root(this, ConfigGuiCtxDefault.class, "@line5");
      toStringPrivate(dc);
      super.toString(dc.sup());
   }

   public void toString1Line(Dctx dc) {
      dc.root1Line(this, ConfigGuiCtxDefault.class);
      toStringPrivate(dc);
